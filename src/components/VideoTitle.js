    ...
    <div className="relative h-screen">
      ...
      <div className="absolute bottom-12 left-0 w-full px-6 text-white">
        <div className="flex flex-col items-start space-y-6">
          ...
          <p className="text-lg sm:text-xl lg:text-2xl max-w-3xl">{overview}</p>
          <div className="flex gap-4">
            <button className="bg-white text-black px-6 py-3 rounded-md font-semibold flex items-center justify-center border-2 border-white hover:bg-white hover:text-black">
              <svg
            ...
            <button className="bg-gray-700 text-white px-6 py-3 rounded-md font-semibold flex items-center justify-center hover:bg-gray-600">
              <svg
                className="w-6 h-6 mr-2"
                xmlns="http://www.w3.org/2000/svg"
                fill="none"
